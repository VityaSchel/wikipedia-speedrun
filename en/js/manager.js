...
iframe.addEventListener("load", function(){
  ...
  if(iframe.src == "https://wikipedia.utidteam.com/en/wikipedia.php?page="+encodeURI(customPage)){
...
function setarticle_root(o) {
  ...
  iframe.src = "https://wikipedia.utidteam.com/en/wikipedia.php?page="+l;
...
function start(s){
  ...
  iframe.src="https://wikipedia.utidteam.com/en/wikipedia.php?page=Special:Random";
